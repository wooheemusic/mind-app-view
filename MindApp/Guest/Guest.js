        ...
        <section className={getClassName('dialog')}>
            <header>
                <p>
                    ...
                    일주일 소요하였고, 5% 완성되었습니다.<br/>

                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/wooheemusic/mind-app-view">
                        https://github.com/wooheemusic/mind-app-view 
